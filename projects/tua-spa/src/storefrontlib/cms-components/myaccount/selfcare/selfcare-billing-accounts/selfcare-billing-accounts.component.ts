...
export class SelfcareBillingAccountsComponent implements OnInit {
  ...
  public listData$: Observable<TmaSelfcareBillingAccounts[]>;
   ...
   */
  protected getSelfcareBillingAccounts(): Observable<
    TmaSelfcareBillingAccounts[]
  > {
    return this.selfcareService.getSelfcareBillingAccounts();
  }
